...
\begin{frame}{Guido van Rossum}
  \begin{columns}
    ...
    \begin{column}{0.6\textwidth}
      \begin{itemize}
        \item John McCarthy while at Massachusetts Institute of Technology.
        \vspace{0.25cm}
        \item Created Lisp.
        \vspace{0.25cm}
        \item Lisp generally considered first functional programming language (not really though).
        \vspace{0.25cm}
        \item Scheme and Dylan were later attempts to simplify and improve Lisp.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
