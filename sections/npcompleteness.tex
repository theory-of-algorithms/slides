...
\begin{frame}{Non-deterministic Turing machine}
  \begin{description}
    ...
    \item[Deterministic Turing machines] have a row in their state table for every combination of (non-terminal) state and tape symbol.
    ...
    \item[Essentially] they allow for parallel computation -- they can follow two or more paths at a time.
  \end{description}
\end{frame}
